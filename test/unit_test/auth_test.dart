...
TestWidgetsFlutterBinding.ensureInitialized();
  ...
  setUp(() {
    ...
    container = ProviderContainer(overrides: [
      authViewModelProvider.overrideWith(
        (ref) => AuthViewModel(mockLoginViewNavigator, mockAuthUsecase, mockRegisterViewNavigator),
      )
    ]);
  });
  ...
  test('login test with valid emailOrPhoneNumber and password', () async {
    ...
    when(mockAuthUsecase.loginUser('shadip@shadip.com', 'shadip1234')).thenAnswer(
      (_) => Future.value(
        Left(
...
// for (any, any) make auth_usecase (emailOrPhoneNumber and password as nullable wih ?)
